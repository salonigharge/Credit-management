            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item "><a class="nav-link" href="./index.php"><span class="fa fa-home fa-lg"></span> Home</a></li>
                     <li class="nav-item active"><a class="nav-link" href="./allusers.php"><span class="fa fa-address-card fa-lg"></span> View Users</a></li>
    ...
    <div class="container" style=" padding-top:200px;"  >
          <div class="row">
             <div class="col-sm offset-md-3 col-md-6">
                  <div class="panel panel-default bg-dark  " style="padding: 10px; color:white; border-radius: 20px;">
                       <h2>User Details</h2>
            ...
            <p><b>Credits:</b> <?php echo htmlentities($row['user_credits']); ?></p>   
