...
<body>
 ...
 <!--BUTTONS START-->
<div class="container-fluid click" align="center"> 
        <div class="row row-content">
            <div class="offset-4 col-4">
              <a href="allusers.php"><button class="btn-lg" >VIEW USERS</button></a>
            </div>
       </div>
       <div class="row row-content">
            <div class="offset-4 col-4 ">
              <button class="btn-lg" id="trans">TRANSFER CREDITS</button>
            </div>
       </div> 
       <div class="row row-content">
            <div class="offset-4 col-4 ">
              <a href="history.php"><button class="btn-lg" id="hist">TRANSACTION HISTORY</button></a> 
            </div>
       </div>       
</div>
<!--BUTTONS START-->
